(function($) {
   ...
   if ($("#wish-form").length) {
        ...
        $("#wish-form").validate({
            ...
            messages: {
                name: {
                    required: (typeof messageNameRequired != 'undefined') ? messageNameRequired : 'Vui lÃ²ng nháº­p tÃªn cá»§a báº¡n.',
                    minlength: (typeof messageNameMinlength != 'undefined') ? messageNameMinlength : 'TÃªn pháº£i lá»›n hÆ¡n 3 kÃ½ tá»±.',
                },
                content: {
                    required: (typeof messageContentRequired != 'undefined') ? messageContentRequired : 'Vui lÃ²ng nháº­p lá»i chÃºc.',
                    minlength: (typeof messageContentMinlength != 'undefined') ? messageContentMinlength : 'Lá»i chÃºc pháº£i lá»›n hÆ¡n 10 kÃ½ tá»±.',
                },
                email: {
                    email: (typeof messageEmailEmail != 'undefined') ? messageEmailEmail : 'Äá»‹a chá»‰ email khÃ´ng há»£p lá»‡.',
                }
            },
